...
public class EffectUtils {
    ...
    public static void playSpawnEffect(Entity entity) {
        ...
        entity.getWorld().playSound(loc, Sound.ENTITY_ENDERMAN_TELEPORT, 1, (float) (1.2 + Math.random() * 0.4));
    ...
    public static void playDespawnEffect(Entity entity) {
        ...
        entity.getWorld().playSound(loc, Sound.ENTITY_ENDERMAN_TELEPORT, 1, (float) (0.6 + Math.random() * 0.4));
